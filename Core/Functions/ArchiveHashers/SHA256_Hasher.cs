...
{
/// <summary> Initializes Secure Hash Algorithm-256 (SHA-256) functions for Files. </summary>

public class SHA256_Hasher : Sha256StringDigest
{
/** <summary> Hashes a File by using SHA-256 Digest. </summary>
...
/** <summary> Hashes all the Files of a Folder by using SHA-256 Digest. </summary>
...
Action<string, string> hashAction = GetHashAction(useAuthCode, cipherKey, false);
...
/** <summary> Hashes a FileSystem by using SHA-256 Digest. </summary>
