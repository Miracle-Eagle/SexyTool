...
{
/// <summary> Initializes Compressing and Decompressing Functions for Files by using the BZip2 algorithm. </summary>

public class BZip2_Compressor
{
/** <summary> Sets a Value which Contains Info about the Extension of a BZip2 file. </summary>
<returns> The BZip2 File Extension. </returns> */

private static readonly string bzip2FileExt = ".bz2";
...
Path_Helper.AddExtension(ref outputPath, bzip2FileExt);
Archive_Manager.CheckDuplicatedPath(ref outputPath);

using FileStream outputFile = File.OpenWrite(outputPath);
using BZip2OutputStream compressionStream = new(outputFile);
...
/** <summary> Compresses the Contents of a Folder by using BZip2 Compression. </summary>
...
/** <summary> Compresses a FileSystem by using BZip2 Compression. </summary>
...
Path_Helper.RemoveExtension(ref outputPath, bzip2FileExt);
Archive_Manager.CheckDuplicatedPath(ref outputPath);
...
/** <summary> Decompresses the Contents of a Folder by using BZip2 Compression. </summary>
...
Task_Manager.BatchTask(inputPath, outputPath, decompressAction, bzip2FileExt);
}
...
/** <summary> Decompresses a FileSystem by using BZip2 Compression. </summary>
...
/** <summary> Gets a Decompress Action by using the Specified Batch Mode. </summary>
