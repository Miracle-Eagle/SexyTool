...
{
/// <summary> Initializes Compressing and Decompressing Functions for Files by using the GZip algorithm. </summary>

public class GZip_Compressor
{
/** <summary> Sets a Value which Contains Info about the Extension of a GZip file. </summary>
<returns> The GZip File Extension. </returns> */

private static readonly string gzipFileExt = ".gz";

/** <summary> Compresses the Contents of a File by using GZip Compression. </summary>
...
Path_Helper.AddExtension(ref outputPath, gzipFileExt);
Archive_Manager.CheckDuplicatedPath(ref outputPath);

using FileStream outputFile = File.OpenWrite(outputPath);
using GZipStream compressionStream = new(outputFile, compressionLvl);
...
/** <summary> Compresses the Contents of a Folder by using GZip Compression. </summary>
...
/** <summary> Compresses a FileSystem by using GZip Compression. </summary>
...
/** <summary> Decompresses the Contents of a File by using GZip Compression. </summary>
...
Path_Helper.RemoveExtension(ref outputPath, gzipFileExt);
Archive_Manager.CheckDuplicatedPath(ref outputPath);
...
/** <summary> Decompresses the Contents of a Folder by using GZip Compression. </summary>

<param name = "inputPath"> The Path where the Folder to be Decompressed is Located. </param>
...
Task_Manager.BatchTask(inputPath, outputPath, decompressAction, gzipFileExt);
}
...
/** <summary> Decompresses a FileSystem by using GZip Compression. </summary>
