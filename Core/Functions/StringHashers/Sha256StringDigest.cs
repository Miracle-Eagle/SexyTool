...
{
/// <summary> Initializes Secure Hash Algorithm (SHA-256) functions for Strings. </summary>

public class Sha256StringDigest
{
/** <summary> Creates a new Instance of the SHA-256 Algorithm. </summary>
<returns> The SHA-256 Algorithm. </returns> */

private static HashAlgorithm digestAlgorithm = SHA256.Create();
...
public static readonly Limit<int> cipherKeySize = new(32, 64);

/** <summary> Displays the SHA-256 Digest of a String. </summary>
...
/** <summary> Hashes an Array of Bytes by using SHA-256 Digest. </summary>
...
digestAlgorithm = new HMACSHA256(cipherKey);
...
/** <summary> Hashes a Stream by using SHA-256 Digest. </summary>
