...
{
/// <summary> Initializes Secure Hash Algorithm (SHA-1) functions for Strings. </summary>

public class Sha1StringDigest
{
/** <summary> Creates a new Instance of the SHA-1 Algorithm. </summary>
<returns> The SHA-1 Algorithm. </returns> */

private static HashAlgorithm digestAlgorithm = SHA1.Create();
...
public static readonly Limit<int> cipherKeySize = new(20, 64);

/**<summary> Displays the SHA-1 Digest of a String. </summary>
...
/** <summary> Hashes an Array of Bytes by using SHA-1 Digest. </summary>
...
digestAlgorithm = new HMACSHA1(cipherKey);
...
/** <summary> Hashes a Stream by using SHA-1 Digest. </summary>
