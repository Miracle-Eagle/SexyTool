...
public class RijndaelInfo : GenericCryptoInfo
{
/** <summary> Sets a Value which Contains Info about the Range of Iterations. </summary>
<returns> The Range of Iterations. </returns> */

private static readonly Limit<int> IterationsRange = Rijndael_Cryptor.iterationsRange;
...
/** <summary> Gets or Sets the BlockCipher Name used for Encrypting/Decrypting Data. </summary>
<returns> The BlockCipher Name Obtained. </returns> */
...
<returns> The CipherPadding Index Obtained. </returns> */

public int CipherPaddingIndex{ get; set; }

/// <summary> Creates a new Instance of the RijndaelInfo Class. </summary>

public RijndaelInfo()
{
CipherKeySize = Rijndael_Cryptor.cipherKeySize;
...
/** <summary> The logic to be Applied when the User selects an Argument from 'RijndaelInfo'. </summary>
...
case "BlockCipherName":
BlockCipherName = Interface.GetUserSelection<BlockCipherNameSelection>().GetSelectionParam() as string;
break;

case "CipherPaddingIndex":
CipherPaddingIndex = (int)Interface.GetUserSelection<CipherPaddingSelection>().GetSelectionParam();
break;
...
/// <summary> Checks each nullable Field of the 'RijndaelInfo' Instance and Validates them. </summary>
...
/// <summary> Edits the Info given in the 'RijndaelInfo' instance. </summary>

public override void EditGroupInfo()
{
ActionWrapper<string> selectionLogic = new( ParamSelectionLogic );
ComitChanges<RijndaelInfo>(selectionLogic.Init);
}
