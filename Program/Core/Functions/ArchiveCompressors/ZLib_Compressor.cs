...
{
/// <summary> Initializes Compressing and Decompressing Functions for Files by using the ZLib algorithm. </summary>

public class ZLib_Compressor
{
/** <summary> Sets a Value which Contains Info about the Extension of a ZLib file. </summary>
<returns> The ZLib File Extension. </returns> */

private static readonly string zlibFileExt = ".zlib";

/** <summary> Compresses the Contents of a File by using ZLib Compression. </summary>
...
Path_Helper.AddExtension(ref outputPath, zlibFileExt);
Archive_Manager.CheckDuplicatedPath(ref outputPath);

using FileStream outputFile = File.OpenWrite(outputPath);
using ZLibStream compressionStream = new(outputFile, compressionLvl);
...
/** <summary> Compresses the Contents of a Folder by using ZLib Compression. </summary>
...
<exception cref = "DictionaryNotFoundException"></exception>
<exception cref = "IOException"></exception>
<exception cref = "NotSupportedException"></exception>
<exception cref = "SecurityException"></exception>
<exception cref = "UnauthorizedAccessException"></exception> */
...
/** <summary> Compresses a FileSystem by using ZLib Compression. </summary>
...
/** <summary> Decompresses the Contents of a File by using ZLib Compression. </summary>
...
Path_Helper.RemoveExtension(ref outputPath, zlibFileExt);
Archive_Manager.CheckDuplicatedPath(ref outputPath);
...
/** <summary> Decompresses the Contents of a Folder by using ZLib Compression. </summary>
...
Task_Manager.BatchTask(inputPath, outputPath, decompressAction, zlibFileExt);
}
...
/** <summary> Decompresses a FileSystem by using ZLib Compression. </summary>
