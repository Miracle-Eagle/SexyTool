...
{
/// <summary> Initializes Compressing and Decompressing Functions for Files by using the LZ4 algorithm. </summary>

public class LZ4_Compressor
{
/** <summary> Sets a Value which Contains Info about the Extension of a LZ4 file. </summary>
<returns> The LZ4 File Extension. </returns> */

private static readonly string lz4FileExt = ".lz4";
...
Path_Helper.AddExtension(ref outputPath, lz4FileExt);
Archive_Manager.CheckDuplicatedPath(ref outputPath);

using FileStream outputFile = File.OpenWrite(outputPath);
using LZ4EncoderStream compressionStream = LZ4Stream.Encode(outputFile);
...
/** <summary> Compresses the Contents of a Folder by using LZ4 Compression. </summary>
...
/** <summary> Compresses a FileSystem by using LZ4 Compression. </summary>
...
Path_Helper.RemoveExtension(ref outputPath, lz4FileExt);
Archive_Manager.CheckDuplicatedPath(ref outputPath);

using FileStream outputFile = File.OpenWrite(outputPath);
using LZ4DecoderStream decompressionStream = LZ4Stream.Decode(inputFile);
...
/** <summary> Decompresses the Contents of a Folder by using LZ4 Compression. </summary>
...
Task_Manager.BatchTask(inputPath, outputPath, decompressAction, lz4FileExt);
}
...
/** <summary> Decompresses a FileSystem by using LZ4 Compression. </summary>
