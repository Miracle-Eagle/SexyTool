...
{
/// <summary> Initializes Compressing and Decompressing Functions for Files by using the Brotli algorithm. </summary>

public class Brotli_Compressor
{
/** <summary> Sets a Value which Contains Info about the Extension of a Brotli file. </summary>
<returns> The Brotli File Extension. </returns> */

private static readonly string brotliFileExt = ".br";

/** <summary> Compresses the Contents of a File by using Brotli Compression. </summary>
...
Path_Helper.AddExtension(ref outputPath, brotliFileExt);
Archive_Manager.CheckDuplicatedPath(ref outputPath);

using FileStream outputFile = File.OpenWrite(outputPath);
using BrotliStream compressionStream = new(outputFile, compressionLvl);
...
/** <summary> Compresses the Contents of a Folder by using Brotli Compression. </summary>
...
/** <summary> Decompresses the Contents of a File by using Brotli Compression. </summary>
...
Path_Helper.RemoveExtension(ref outputPath, brotliFileExt);
Archive_Manager.CheckDuplicatedPath(ref outputPath);
...
Task_Manager.BatchTask(inputPath, outputPath, decompressAction, brotliFileExt);
}
