...
{
/// <summary> Initializes Secure Hash Algorithm (SHA-512) functions for Strings. </summary>

public class Sha512StringDigest
{
/** <summary> Creates a new Instance of the SHA-512 Algorithm. </summary>
<returns> The SHA-512 Algorithm. </returns> */

private static HashAlgorithm digestAlgorithm = SHA512.Create();
...
public static readonly Limit<int> cipherKeySize = new(64, 128);

/** <summary> Displays the SHA-512 Digest of a String. </summary>
...
/** <summary> Hashes an Array of Bytes by using SHA-512 Digest. </summary>
...
digestAlgorithm = new HMACSHA512(cipherKey);
...
/** <summary> Hashes a Stream by using SHA-512 Digest. </summary>
