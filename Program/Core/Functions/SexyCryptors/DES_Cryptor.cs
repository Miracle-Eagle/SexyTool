...
{
/// <summary> Initializes Data Encryption Standard (DES) Ciphering Functions for Files. </summary>

public class DES_Cryptor
{
/** <summary> Creates a new Instance of the DES Algorithm. </summary>
<returns> The DES Algorithm. </returns> */

private static readonly DES cipherAlgorithm = DES.Create();
...
public static readonly Limit<int> cipherKeySize = new(8);
...
public static readonly Limit<int> iterationsRange = new(16);

/** <summary> Encrypts a File by using DES Ciphering. </summary>
...
/** <summary> Encrypts all the Files of a Folder by using DES Ciphering. </summary>
...
/** <summary> Encrypts a FileSystem by using DES Ciphering. </summary>
...
/** <summary> Decrypts a File that was Encrypted with DES Ciphering. </summary>
...
/** <summary> Decrypts all the Files of a Folder by using DES Ciphering. </summary>
...
/** <summary> Decrypts a FileSystem by using DES Ciphering. </summary>
